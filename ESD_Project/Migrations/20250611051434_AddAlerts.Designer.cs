...
namespace ESD_Project.Migrations
{
    ...
    [Migration("20250611051434_AddAlerts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlertDefinitionAlertRecipient", b =>
                {
                    b.Property<int>("AlertDefinitionsId")
                        .HasColumnType("int");

                    b.Property<int>("RecipientsId")
                        .HasColumnType("int");

                    b.HasKey("AlertDefinitionsId", "RecipientsId");

                    b.HasIndex("RecipientsId");

                    b.ToTable("AlertDefinitionAlertRecipient");
                });
            ...
            modelBuilder.Entity("ESD_Project.Models.AlertRecipient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlertDefinitionAlertRecipient", b =>
                {
                    b.HasOne("ESD_Project.Models.AlertDefinition", null)
                        .WithMany()
                        .HasForeignKey("AlertDefinitionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ESD_Project.Models.AlertRecipient", null)
                        .WithMany()
